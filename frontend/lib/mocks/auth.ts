...
const MOCK_USERS: (AuthUser & { password: string })[] = [
  {
    ...
    hostelName: 'Green Valley Hostels',
    organizationName: 'Green Valley Hostels',
...
export const mockBranches = [
  { id: 'br-hyd001', code: 'HYD001', name: 'Green Valley Hostels', hostelName: 'Green Valley Hostels', branchName: 'Main Branch', city: 'Hyderabad' },
  { id: 'br-hyd002', code: 'HYD002', name: 'Green Valley Hostels', hostelName: 'Green Valley Hostels', branchName: 'Jubilee Hills', city: 'Hyderabad' },
  { id: 'br-hyd003', code: 'HYD003', name: 'Green Valley Hostels', hostelName: 'Green Valley Hostels', branchName: 'Madhapur', city: 'Hyderabad' },
];
